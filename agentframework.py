...
class Agent:
    ...
    def move(self):
        ...
        #position by +1 from its original value. If more than 0.5, move -1
    ...
    def eat_until_full(self): 
        # Eating the environment as they move and gaining +10 in their store 
    ...
    def share_with_neighbours(self, neighbourhood):
        # If the agents come close enough to each other, shorter than the value of 
